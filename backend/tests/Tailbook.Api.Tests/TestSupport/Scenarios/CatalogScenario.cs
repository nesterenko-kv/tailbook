...
internal sealed class CatalogScenario(HttpClient client)
{
...
internal sealed record VisitReadyOffer(Guid OfferId, Guid FirstProcedureId, Guid SecondProcedureId);
