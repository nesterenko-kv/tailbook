...
public sealed class VisitOperationsAggregateTests
{
    ...
    [Fact]
    public void Check_in_returns_all_top_level_validation_errors()
    {
        ...
        AssertErrorCodes(
            result,
            "VisitOperations.VisitIdRequired",
            "VisitOperations.AppointmentRequired",
            "VisitOperations.ExecutionItemsRequired");
    }
    ...
    [Fact]
    public void Check_in_returns_all_invalid_execution_item_errors()
    {
        var result = Visit.CheckIn(
            Guid.NewGuid(),
            Guid.NewGuid(),
            [CreateExecutionItemDraft(
                appointmentItemId: Guid.Empty,
                itemType: " ",
                offerId: Guid.Empty,
                ...
                quantity: 0,
                priceAmountSnapshot: -1m,
                serviceMinutesSnapshot: 0,
                reservedMinutesSnapshot: 0)],
            null,
            Utc("2026-04-24T07:00:00Z"));

        AssertErrorCodes(
            result,
            "VisitOperations.ExecutionItemAppointmentItemRequired",
            "VisitOperations.ExecutionItemTypeRequired",
            "VisitOperations.ExecutionItemOfferRequired",
            "VisitOperations.ExecutionItemOfferVersionRequired",
            "VisitOperations.ExecutionItemOfferCodeRequired",
            "VisitOperations.ExecutionItemOfferDisplayNameRequired",
            "VisitOperations.ExecutionItemQuantityInvalid",
            "VisitOperations.ExecutionItemPriceInvalid",
            "VisitOperations.ExecutionItemServiceMinutesInvalid",
            "VisitOperations.ExecutionItemReservedMinutesInvalid");
    }
    ...
    public void Recording_performed_procedure_starts_visit_and_blocks_duplicates()
    {
        ...
        var performed = AssertSuccess(visit.RecordPerformedProcedure(
            item.Id,
        ...
        Assert.Equal(Utc("2026-04-24T07:15:00Z"), visit.StartedAt);
        Assert.Equal("done", performed.Note);
        Assert.Single(item.PerformedProcedures);
        AssertError(visit.RecordPerformedProcedure(
            item.Id,
    ...
    [Fact]
    public void Recording_performed_procedure_returns_all_validation_errors()
    {
        var visit = CreateVisit();
        var item = visit.ExecutionItems.Single();

        var result = visit.RecordPerformedProcedure(
            item.Id,
            CreatePerformedProcedureDraft(
        ...
        AssertErrorCodes(
            result,
            "VisitOperations.PerformedProcedureProcedureRequired",
            "VisitOperations.PerformedProcedureCodeRequired",
            "VisitOperations.PerformedProcedureNameRequired");
    }
    ...
    public void Recording_skipped_component_normalizes_reason_and_blocks_duplicates()
    {
        ...
        var skipped = AssertSuccess(visit.RecordSkippedComponent(
            item.Id,
        ...
        AssertError(visit.RecordSkippedComponent(
            item.Id,
    ...
    [Fact]
    public void Recording_skipped_component_returns_all_validation_errors()
    {
        var visit = CreateVisit();
        var item = visit.ExecutionItems.Single();

        var result = visit.RecordSkippedComponent(
            item.Id,
            CreateSkippedComponentDraft(
                offerVersionComponentId: Guid.Empty,
                procedureId: Guid.Empty,
                procedureCodeSnapshot: " ",
                procedureNameSnapshot: " ",
                omissionReasonCode: " "),
        ...
        AssertErrorCodes(
            result,
            "VisitOperations.SkippedComponentOfferVersionComponentRequired",
            "VisitOperations.SkippedComponentProcedureRequired",
            "VisitOperations.SkippedComponentProcedureCodeRequired",
            "VisitOperations.SkippedComponentProcedureNameRequired",
            "VisitOperations.RequiredCodeMissing");
    }
    ...
    public void Price_adjustment_rounds_normalizes_and_blocks_negative_final_total()
    {
        ...
        var adjustment = AssertSuccess(visit.ApplyPriceAdjustment(
        ...
        AssertError(visit.ApplyPriceAdjustment(
    ...
    public void Price_adjustment_returns_all_validation_errors()
    {
        ...
        var result = visit.ApplyPriceAdjustment(
            new VisitPriceAdjustmentDraft(0, 50m, " ", null),
            null,
            Utc("2026-04-24T08:00:00Z"));

        AssertErrorCodes(
            result,
            "VisitOperations.InvalidAdjustmentSign",
            "VisitOperations.RequiredCodeMissing");
    }
    ...
    public void Lifecycle_allows_complete_then_close()
    {
        ...
        Assert.Equal(Utc("2026-04-24T09:00:00Z"), visit.CompletedAt);
    ...
    public void Lifecycle_rejects_forbidden_paths_and_terminal_mutations()
    {
        ...
        AssertError(visit.Close(null, Utc("2026-04-24T08:30:00Z")));
        ...
        AssertSuccess(visit.Close(null, Utc("2026-04-24T09:15:00Z")));
        AssertError(visit.Complete(null, Utc("2026-04-24T09:20:00Z")));
        AssertError(visit.ApplyPriceAdjustment(
    ...
    public async Task Visit_aggregate_round_trips_through_ef_core()
    {
        ...
        var visit = CreateVisit();
        var itemId = visit.ExecutionItems.Single().Id;
        AssertSuccess(visit.RecordPerformedProcedure(itemId, CreatePerformedProcedureDraft(), null, Utc("2026-04-24T07:15:00Z")));
        AssertSuccess(visit.RecordSkippedComponent(itemId, CreateSkippedComponentDraft(), null, Utc("2026-04-24T07:20:00Z")));
        AssertSuccess(visit.ApplyPriceAdjustment(new VisitPriceAdjustmentDraft(-1, 150m, "CALMER_THAN_EXPECTED", null), null, Utc("2026-04-24T08:00:00Z")));
    ...
    private static List<Error> AssertError<T>(ErrorOr<T> result)
    {
