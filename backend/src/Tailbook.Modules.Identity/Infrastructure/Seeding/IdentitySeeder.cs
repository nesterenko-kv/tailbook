...
public sealed class IdentitySeeder(IOptions<BootstrapAdminOptions> bootstrapAdminOptions, PasswordHasher passwordHasher, TimeProvider timeProvider) : IDataSeeder
{
    public int Order => 10;
