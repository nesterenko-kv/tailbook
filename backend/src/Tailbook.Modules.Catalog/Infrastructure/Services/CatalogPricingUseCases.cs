...
public sealed class CatalogPricingUseCases(AppDbContext dbContext, IPetTaxonomyValidationService petTaxonomyValidationService) : ICatalogPricingReadService
{
