...
public interface IClientPortalBookingQueries
{
    Task<ErrorOr<BookingRequestDetailView>> CreateMyBookingRequestAsync(ClientPortalActor actor, CreateClientBookingRequestCommand command, CancellationToken cancellationToken);
