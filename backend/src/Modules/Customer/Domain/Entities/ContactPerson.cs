...
public sealed class ContactPerson
{
    ...
    public ContactMethod AddContactMethod(
        string methodType,
        string rawValue,
        string displayValue,
        bool isPreferred,
    ...
    public void ClearPreferredMethods(DateTimeOffset utcNow)
    {
    ...
    public ContactMethod? GetMethod(string methodType, string rawValue)
    {
