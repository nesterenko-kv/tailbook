...
public sealed class AddContactPersonEndpoint : Endpoint<AddContactPersonRequest, AddContactPersonResponse>
{
    ...
    {
        var command = new AddCustomerContactPersonCommand(
            req.ClientId,
            req.FirstName,
            req.LastName,
            req.Notes,
        ...
        var contact = await command.ExecuteAsync(ct);
        if (contact is null)
        {
