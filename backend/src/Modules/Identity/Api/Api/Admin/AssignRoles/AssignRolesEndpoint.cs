...
public sealed class AssignRolesEndpoint : Endpoint<AssignRolesRequest, AssignRolesResponse>
{
    ...
    {
        var command = new AssignIdentityRolesCommand(req.Id, req.RoleCodes, req.ActorUserId);
