...
public sealed class BookingSnapshotComposer(
    ...
    TimeProvider timeProvider) : IBookingSnapshotComposer
{
    public async Task<ErrorOr<QuotePreviewView>> CreatePreviewAsync(PreviewQuoteQuery command, Guid? actorUserId, CancellationToken cancellationToken)
    {
