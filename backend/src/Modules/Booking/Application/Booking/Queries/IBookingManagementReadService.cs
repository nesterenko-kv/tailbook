...
{
    Task<PagedResult<BookingRequestListItemView>> ListBookingRequestsAsync(string? search, string? status, int page, int pageSize, string? sortBy, string? sortDirection, CancellationToken cancellationToken);
    ...
    Task<PagedResult<AppointmentListItemView>> ListAppointmentsAsync(string? search, DateTimeOffset? from, DateTimeOffset? to, Guid? groomerId, int page, int pageSize, string? sortBy, string? sortDirection, CancellationToken cancellationToken);
