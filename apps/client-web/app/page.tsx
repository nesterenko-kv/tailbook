    ...
    return (
        <main className="mx-auto flex min-h-screen max-w-5xl flex-col gap-8 px-6 py-16">
            <section className="space-y-4">
                ...
                <h1 className="text-4xl font-semibold tracking-tight">Tailbook Client Portal</h1>
                <p className="max-w-2xl text-slate-300">
                    This is the isolated client portal application shell for Tailbook. Real routes, auth-aware layout, and domain screens land in later stages.
                </p>
            </section>
