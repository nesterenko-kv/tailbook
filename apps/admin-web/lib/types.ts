...
export type GenerateMfaRecoveryCodesResponse = {
    recoveryCodes: string[];
    activeCodeCount: number;
    createdAt: string;
};

export type ResetMfaRecoveryResponse = {
    userId: string;
    disabledFactorCount: number;
    invalidatedRecoveryCodeCount: number;
...
export type BookingRequestDetail = {
    ...
    preferredTimes: Array<{ startAt: string; endAt: string; label?: string | null }>;
    notes?: string | null;
...
export type VisitDetail = {
    ...
    items: Array<{
        ...
        performedProcedures: Array<{ id: string; procedureId: string; procedureCode: string; procedureName: string; status: string; note?: string | null; recordedAt: string }>;
        skippedComponents: Array<{ id: string; offerVersionComponentId: string; procedureId: string; procedureCode: string; procedureName: string; omissionReasonCode: string; note?: string | null; recordedAt: string }>;
    }>;
    adjustments: Array<{ id: string; sign: number; amount: number; reasonCode: string; note?: string | null; createdAt: string }>;
    createdAt: string;
    updatedAt: string;
};
...
export type NotificationJobDetail = NotificationJobListItem & {
    attempts: NotificationDeliveryAttemptItem[];
};
...
export type NotificationDeadLetterByEvent = {
    eventType: string;
    count: number;
};
...
export type NotificationDashboard = {
    ...
    deadLetterByEventType: NotificationDeadLetterByEvent[];
    deadLetterToday: number;
    deadLetterLast7Days: number;
    deadLetterOlder: number;
